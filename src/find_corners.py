...
import roslib
roslib.load_manifest('interactive_segmentation_textured_groovy')
import rospy
...
import interactive_segmentation_textured_groovy.srv
...
#looking for the line from the direction
    ...
    def findCornersService(self,req):
        ...
        res = interactive_segmentation_textured_groovy.srv.cornerFindResponse()
...
if __name__ == '__main__':
    ...
    rospy.sleep(1.0)
    cf = CornerFinder()
    s = rospy.Service('find_corners',  interactive_segmentation_textured_groovy.srv.cornerFind, lambda a: cf.findCornersService(a) )
    rospy.spin()
